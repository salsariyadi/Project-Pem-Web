...
<html>
    ...
    <body>
        <div class="container-fluid">
                ...
                <div class="col-sm-3 border">
                    <nav class="navbar bg-dark navbar-dark p-4">
                        <ul class="navbar-nav">
                            ...
                            <li class="navbar-brand">
                                <a class="nav-link" href="userAcc.php">Akun Anda</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#home">Home</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="../html/profile.html">Profile Band</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="home row border mt-4">

                <div class="col-sm-3 border">

                </div>

                <div class="d-flex flex-column col-sm-8 p-3">
                    <div class="flex-item">
